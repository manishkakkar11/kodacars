...
import { ArrowLeft, Truck, Check, Download, ArrowRight, Loader2, AlertCircle, Shield } from 'lucide-react';
...
const LargeVehiclePage: React.FC = () => {
  ...
  const whitepaperInfo = getWhitepaperInfo('large-vehicle');
  ...
  const handlePDFDownload = () => {
    if (whitepaperInfo) {
      downloadWhitepaper('large-vehicle');
    }
  };
              ...
              {!submitted ? (
                ...
                <div className="bg-white border border-gray-200 p-12 text-center shadow-xl animate-fade-in-up">
                  ...
                  <p className="text-gray-600 text-lg mb-10 leading-relaxed">
                    Thank you, {formData.firstName}! Your large vehicle optimization framework is now available for download.
                  </p>
                  <button 
                  ...
                  >
                    <Download size={24} />
                    Download PDF ({whitepaperInfo?.size || '2.6 MB'})
                  </button>
